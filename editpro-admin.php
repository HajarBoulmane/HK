    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-9 main">
                <div class="blogs">
                    <h1 class="text-center" style="margin-bottom:30px;">List of commands</h1>
                        ...
                        <div class="product">
                            <form action="editpro.php" method="post">
                                <table>
                                    ...
                                    <tr>
                                        <td><input type="text" name="id" required class="input"
                                    ...
                                    <tr>
                                        <td><input type="text" name="description" required class="input"
                                    ...
                                    <tr>
                                        <td><input type="text" name="category" required class="input"
                                    ...
                                    <tr>
                                        <td><input type="text" name="price" required class="input"
                                    ...
                                    <tr>
                                        <td><textarea name="desc_detailed" required
                                                class="textarea"><?php echo $desc_detailed; ?></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input type="text" name="gender" required class="input"
                                    ...
                                    <tr>
                                        <td><input type="text" name="quantite_stock" required class="input"
                                                value=<?php echo"$quantite_stock" ;?>></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-right" colspan="2">
                                            <input type="submit" class="btn btnvalider" value="Edit">
                                        </td>
                                    </tr>
                                </table>
                            </form>
