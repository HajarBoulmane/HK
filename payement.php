...
<body>
    ...
    <form class="form" action="signupvalid.php" method="post">
        ...
        <label>
            <input required="" name="password1" type="password" class="input">
            <span>Password</span>
        </label>
        <label>
            <input required="" name="password2" type="password" class="input">
